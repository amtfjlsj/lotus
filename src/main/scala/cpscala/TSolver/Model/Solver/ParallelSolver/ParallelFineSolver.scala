...
class ParallelFineSolver(xm: XModel, parallelism: Int, propagatorName: String, varType: String, heuName: String) extends ParallelSolver(xm, parallelism, propagatorName, varType, heuName) {
