...
import cpscala.TSolver.Model.Constraint.SerialConstraint.BitSupport
import cpscala.TSolver.Model.Variable.ParallelVar

import scala.collection.mutable.ArrayBuffer
import scala.util.control.Breaks.{break, breakable}

class PSTRbit(val id: Int, val arity: Int, val num_vars: Int, val scope: Array[ParallelVar], val tuples: Array[Array[Int]], val helper: ParallelSearchHelper) extends ParallelPropagator {
